...
def represent_input_with_features(history, features2id: Feature2IdClass):
    ...
    if (pword, ctag) in features2id.prev_words_tags_dict:
        features.append(features2id.prev_words_tags_dict[(pword, ctag)])
    if (nword, ctag) in features2id.next_words_tags_dict:
        features.append(features2id.next_words_tags_dict[(nword, ctag)])
